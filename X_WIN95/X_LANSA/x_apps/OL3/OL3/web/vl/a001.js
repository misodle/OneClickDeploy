...
function( Lansa, objectId, undefined )
{
   ...
   var COM_OWNER = Lansa.registerClass( objectId,
   {
      ...
      co: function()
      {
         ...
         // ---------------------------
         //
         // DEFINE_COM Class(#PRIM_LABL) Name(#Label1) Caption('TEST2') Displayposition(1) Ellipses(Word) Height(25) Left(257) Parent(#COM_OWNER) Tabposition(1) Tabstop(False) Top(208) Verticalalignment(Center) Width(120)
         //
