...
function( Lansa, objectId, undefined )
{
   ...
   var COM_OWNER = Lansa.registerClass( objectId,
   {
      ...
      co: function()
      {
         ...
         //
         // DEFINE_COM Class(#PRIM_MD.Label) Name(#Label) Caption('VIEW 2') DisplayPosition(1) Height(450) IconHeight(0) Left(0) Parent(#COM_OWNER) TabPosition(1) TabStop(False) Top(0) Width(300) IconAlignment(TopCenter) ThemeDrawStyle('Heading1')
         //
